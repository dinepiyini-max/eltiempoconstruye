...
export const BOTTLE_GLOSS: Record<string, string> = {
  ...
  "LLUVIA — NO SE VIERTE": "Llueve. El hormigón fresco no se vierte. Espera a que escampe o sigue otro frente.",
  "LLUVIA EN ESTE FRENTE": "Llueve aquí. El ritmo baja. Excavación, armado y encofrado siguen; el vertido no.",
